...
void ConfigFile::ExtractKeys()
{
  ...
  if (!file)
  {
    ...
    outfile << "CONFIG_DISABLE = 0x0030		      # Disables the Gopher        # START + SELECT" << std::endl;
    outfile << "CONFIG_DISABLE_VIBRATION = 0x0011 # Disables Gopher Vibrations # START + DPAD_UP" << std::endl;
